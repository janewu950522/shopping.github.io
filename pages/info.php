...
<?php
    session_start();
    if(!@$_SESSION['buy'] || @$_SESSION['buy']==0){
        echo "<script>
            alert('請先選購商品');
                ...
                <div id="comments">
                    ...
                    <form action="check.php" method="post">
                        ...
                        <div class="one_third">
                            ...
                            <input type="email" name="email" id="email" value="" size="22" required> </div>
                        <div class="one_third">
                            <label for="url">電話<span>*</span></label>
                            <input type="text" name="phone" id="phone" value="" size="22" required>
                        </div>
                        <div class="block clear ">
                            <label for="address">住址 <span>*</span></label>
                            <input type="text" name="address" id="address" value="" size="22" required>
                        </div>
                        <div class="block clear">
                        ...
                        <div style="float: right;">
                            <button class="custom-btn btn-16" type="submit"><span>確定</span></button> &nbsp;
                            <button class="custom-btn btn-16" type="reset" name="reset"><span>清除</span></button>
                        </div>
                    </form>
                </div>
            </div>
